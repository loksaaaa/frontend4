...
function Shopping() {
 ...
 const handleOkItem = () => {
  ...
  const rmMumberById = (id,item) => {
    ...
    let isdelName = window.confirm(" Are you sure you want to remove the member? ")
     ...
     <Modal
      ...
      <Card title="Shopping List">
        <List
          header={
            <div>
              {list.listName} <Button onClick={ChangeName}>Rename</Button> <Button onClick={ addMember} >Add Member</Button>
            </div>
          }
          bordered
        ...
        className="ArchivedList"
          header={
            <div>
              Shopping Items <Button onClick={ includeSolved }>including solved</Button>
            </div>
          }
          footer={
            <div>
          ...
          renderItem={(item) => (
            <List.Item>
              ...
              <Button onClick={ ()=>{ rmItemById(item.id)} }>remove</Button>
              &nbsp; &nbsp; &nbsp; 
              <Button onClick={ ()=>{ changeDone(item.id) }} > { item.isDone ? 'Done' : 'Mark'}</Button>{" "}
            </List.Item>
          )}
        ></List>
      </Card>
